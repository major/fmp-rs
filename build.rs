fn main() {
    ...
    let cmd = clap::Command::new("fmp-agent")
        ...
        .subcommand(clap::Command::new("market-stock-list").about("List supported stock symbols"))
        ...
        .subcommand(clap::Command::new("company-historical-rating").about("Get historical company rating rows for a symbol"))
        ...
        .subcommand(clap::Command::new("fundamentals-annual-report-form").about("Get annual report form JSON for a symbol and fiscal year"))
        ...
        .subcommand(clap::Command::new("insider-trading-latest").about("Get latest insider trading rows"))
        ...
        .subcommand(clap::Command::new("economic-indicators").about("Get economic indicator rows by indicator name and optional date range"))
